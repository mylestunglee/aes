...
\begin{figure}[H]
	...
	\begin{tikzpicture}
		...
		\node[file](cf) at (2.5, 8){\textsc{Construct-Feasibility}};
		\node[file](ce) at (5, 6){\textsc{Construct-Efficiency}};
		\node[file](cs) at (10, 6){\textsc{Construct-\\Satisfaction}};
		\node[file](sf) at (0, 4){\textsc{Explain-Stability}};
		\node[file](se) at (5, 4){\textsc{Explain-Stability}};
		\node[file](ss) at (10, 4){\textsc{Explain-Stability}};
		\node[file](ef) at (0, 2){\textsc{Explain-Feasibility}};
		\node[file](ee) at (5, 2){\textsc{Explain-Efficiency}};
		\node[file](es) at (10, 2){\textsc{Explain-Satisfaction}};
