...
\begin{theorem}[\textbf{Interval scheduling is stability-modellable}]
	...
	\begin{proof}\ 
		\begin{enumerate}
			...
			\item $\left(\bigcup_{\lambda\in\{\alpha,\beta,\gamma,\delta,\varepsilon,\zeta\}}\rightsquigarrow_\lambda\right)$ stability-models $\Lambda$\\\indent\hfill lemma \ref{stabilityalpha}, lemma \ref{conflictfreenessbeta}, 1, 2, 3, lemma \ref{intervalstabilitydependence}, theorem \ref{modelling}
